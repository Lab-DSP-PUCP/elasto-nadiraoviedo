...
BaseDir2 = ['D:\Universidah\AM-FM_demod\SWS_amfm_stimator\AM_FM\h5_files',];
BaseDir = 'D:\Universidah\AM-FM_demod\SWS_amfm_stimator\AM_FM';
swsDir = [BaseDir,'\h5_sws'];

file = [BaseDir2,'\var1_',num2str(rad),'.0_var2_',num2str(bac),'.00_var3_',num2str(inc),'.00\var4_',num2str(frec)];
...
directory=[file,'\sono_radius_',num2str(rad),'.0_sws_back_',num2str(bac),'.00_sws_inc_',num2str(inc),'.00_fvib_',num2str(frec),'_frame_', num2str(id,'%03d'),'.h5'];

%% Normalizado x vs tiempo
    %Properties = h5info(directory);
    sono = h5read(directory,'/sono')
